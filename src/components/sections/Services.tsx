    ...
    <section id="servicios" className="bg-light py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="line-clamp-2 font-serif text-lg text-headline transition-colors group-hover:text-primary">
                  {service.title}
                </h3>
        ...
        <div className="mt-12 text-center">
          <Link
            href="/profesionales"
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:bg-primary-dark hover:shadow-lg hover:shadow-primary/25 sm:w-auto sm:px-8 sm:py-4"
          >
